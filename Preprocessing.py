...
save_path01 = "Data/data_train_preprocessed_50.csv"

labels = utils.delete_users(file_path, min_num_items=50,
                      save_path=save_path01)

# %% Save in the Surprise format
save_path02 = "Data/data_train_preprocessed_surprise_format_50.csv"
